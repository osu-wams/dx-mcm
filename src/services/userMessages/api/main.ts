...
const findByChannel = async (req: Request, res: Response, _next: NextFunction) => {
...
// eslint-disable-next-line no-unused-vars
const markRead = async (req: Request, res: Response, _next: NextFunction) => {
...
// eslint-disable-next-line no-unused-vars
const findByStatus = async (req: Request, res: Response, _next: NextFunction) => {
...
// eslint-disable-next-line no-unused-vars
const findError = async (req: Request, res: Response, _next: NextFunction) => {
